...
<head>
  ...
  <title> รายการที่ถูกร้องขอ | <?php echo $title; ?></title>
...
<div class="wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo $menu['req']; ?>"><i class="fa fa-circle-o"></i> รายการที่ถูกร้องขอ</a></li>
            <li><a href="<?php echo $menu['res']; ?>"><i class="fa fa-circle-o"></i> รายการรอจำหน่าย</a></li>
            <li><a href="<?php echo $menu['return']; ?>"><i class="fa fa-circle-o"></i> รายการอุปกรณ์รอคืน</a></li>
          </ul>
        </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ระบบการยืม
        <small>รายการที่ถูกร้องขอ</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> หน้าหลัก</a></li>
        <li><a href="#">ระบบการยืม</a></li>
        <li class="active">รายการที่ถูกร้องขอ</li>
      </ol>
    </section>

    <!-- Main content -->
    <section class="content">
      <?php include './req/mainContent.php'; ?>
    </section>
    <!-- /.content -->
  </div>
  <!-- /.content-wrapper -->
...
<!-- DataTables -->
<!-- <script src="../bower_components/dt/datatables.js"></script> -->
