...
$columns = array(
    ...
    array( 'db' => '`c`.`chemical`',            'dt' => 9, 'formatter' => function( $d, $row ) {
        ...
        <div class="btn-group" role="group">
            <button type="button" class="btn btn-success btn-xs btn-flat" id="allowCh" >อนุมัติ</button>
            <button type="button" class="btn btn-info btn-xs btn-flat" id="infoCh" >รายละเอียด</button>
            <button type="button" class="btn btn-danger btn-xs btn-flat" id="denyCh" >ปฏิเสธ</button>
        </div>
        ';},
        'field' => 'chemical' ),
