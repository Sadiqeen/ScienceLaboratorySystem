...
<head>
  ...
  <title> รายการรอจำหน่าย | <?php echo $title; ?></title>
...
<div class="wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?php echo $menu['res']; ?>"><i class="fa fa-circle-o"></i> รายการรอจำหน่าย</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ระบบการยืม
        <small>รายการรอจำหน่าย</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> หน้าหลัก</a></li>
        <li><a href="#">ระบบการยืม</a></li>
        <li class="active">รายการรอจำหน่าย</li>
      </ol>
    </section>

    <!-- Main content -->
    <section class="content">
      <?php include './res/mainContent.php'; ?>
    </section>
    <!-- /.content -->
  </div>
  <!-- /.content-wrapper -->
