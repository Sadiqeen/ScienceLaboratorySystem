...
<head>
  ...
  <title> ทำรายการยืม | <?php echo $title; ?></title>
...
<div class="wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li  class="active"><a href="<?php echo $borrowPageLink; ?>"><i class="fa fa-circle-o"></i> ทำรายการยืม</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <?php include './borrow/mainContent.php' ?>
...
<script src="./borrow/js.js"></script>
<script src="./borrow/chemicalFunction.js"></script>
<script src="./borrow/equipmentFunction.js"></script>
</body>
</html>
