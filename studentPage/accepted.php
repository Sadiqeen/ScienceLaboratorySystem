...
<head>
  ...
  <title> ได้รับการตอบรับ | <?php echo $title; ?></title>
...
<div class="wrapper">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <?php echo $_SESSION["name"]; ?>
                  <small>สาขา <?php echo  $_SESSION["department"]; ?></small>
                </p>
              </li>
              <!-- Menu Footer-->
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li  class="active"><a href="<?php echo $acceptedPageLink; ?>"><i class="fa fa-circle-o"></i> ได้รับการตอบรับ</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <?php include './accepted/mainContent.php' ?>
...
<script src="./accepted/js.js"></script>
<script src="./accepted/chemicalFunction.js"></script>
<script src="./accepted/equipmentFunction.js"></script>
</body>
</html>
