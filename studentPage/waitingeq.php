...
<head>
  ...
  <title> อุปกรณ์รอการคืน | <?php echo $title; ?></title>
...
<div class="wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li  class="active"><a href="<?php echo $waitingEqPageLink; ?>"><i class="fa fa-circle-o"></i> อุปกรณ์รอการคืน</a></li>
          </ul>
        </li>
        <li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <?php include './waitingeq/mainContent.php' ?>
...
<script src="./waitingeq/js.js"></script>
</body>
</html>
