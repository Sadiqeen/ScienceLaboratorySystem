...
$columns = array(
    ...
    array( 'db' => '`e`.`Equipment`',            'dt' => 4, 'formatter' => function( $d, $row ) {
		return '
			<div class="btn-group" role="group">
				<button type="button" class="btn btn-primary btn-xs btn-flat" id="edBrEq" >แก้ไข</button>
				<button type="button" class="btn btn-danger btn-xs btn-flat" id="delBrEq" >ยกเลิก</button>
			</div>
		';},
		'field' => 'Equipment' ),
	array( 'db' => '`b`.`equipment_id`',                  'dt' => 5, 'field' => 'equipment_id'  ),
);
