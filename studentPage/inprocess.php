...
<head>
  ...
  <title> กำลังดำเนินการ | <?php echo $title; ?></title>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li  class="active"><a href="<?php echo $inprocessPageLink; ?>"><i class="fa fa-circle-o"></i> กำลังดำเนินการ</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li>ระบบการยืม</li>
        <li class="active">กำลังดำเนินการ</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <?php include './inprocess/mainContent.php' ?>
...
<script src="./inprocess/js.js"></script>
<script src="./inprocess/chemicalFunction.js"></script>
<script src="./inprocess/equipmentFunction.js"></script>
</body>
</html>
