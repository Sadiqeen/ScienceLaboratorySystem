...
<head>
  ...
  <title> แก้ไขข้อมูลส่วนตัว | <?php echo $title; ?></title>
...
<div class="wrapper">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo $_SESSION["profile_img"]; ?>" id="pIm1" class="user-image" alt="User Image">
              <span class="hidden-xs"><?php echo $_SESSION["name"]; ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?php echo $_SESSION["profile_img"]; ?>" id="pIm2" class="img-circle" alt="User Image">

                <p>
                <?php echo $_SESSION["name"]; ?>
                  <small>สาขา <span id="dp"><?php echo  $_SESSION["department"]; ?></span></small>
                </p>
              </li>
              <!-- Menu Footer-->
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="<?php echo $_SESSION["profile_img"]; ?>" id="pIm3" class="img-circle" alt="User Image">
        </div>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo $dashboardPageLink; ?>"><i class="fa fa-dashboard"></i> หน้าหลัก</a></li>
        <li class="active">แก้ไขโปรไฟล์</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <?php include './profile/mainContent.php' ?>
